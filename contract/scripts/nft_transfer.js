...
const nft_transfer_command = `near call ${contract} nft_transfer '${JSON.stringify(token_transfer)}' --accountId ${account_id} --depositYocto=${depositYocto} --gas=${gas}`
