...
export function internal_transfer(sender_id: AccountId, receiver_id: AccountId, token_id: TokenId, approval_id: u64, memo: string): void  {  // should return Token
  ...
  // 
  //       token
  // const token = new Token("owner_id", [], 0);
  // return token;
}
...
// ) -> Promise
export function refund_approved_account_ids_iter(account_id: AccountId, approved_account_ids: u64): void  { // should return Promise instead of void accournding to Rust
  // where
...
// }
export function refund_approved_account_ids(account_id: AccountId, approved_account_ids: u64): void { // should return Promise instead of void accournding to Rust
  // refund_approved_account_ids_iter(account_id, approved_account_ids.keys())
}
